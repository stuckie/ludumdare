...
void Floor1RoomGCollisions::collide(const Resource<Entity>& entityA, const Resource<Entity>& entityB)
{
	...
	if (entityA->getTag() == Fingers::Entities::Player) {
		...
		if (entityB->getTag() == Fingers::Entities::Health) {
			removeFromRoom(entityB, Fingers::Rooms::Floor1::Group, Fingers::Rooms::Floor1::RoomG);
		...
		if (entityB->getTag() == Fingers::Entities::DoorWest) {
			moveToRoom(entityA, Fingers::Rooms::Floor1::Group, Fingers::Rooms::Floor1::RoomG, Fingers::Rooms::Floor1::Group, Fingers::Rooms::Floor1::StartingRoom, true);

			entityA->translate(MOVE_WEST);
		}
	
		if (entityB->getTag() == Fingers::Entities::DoorNorth) {
			moveToRoom(entityA, Fingers::Rooms::Floor1::Group, Fingers::Rooms::Floor1::RoomG, Fingers::Rooms::Floor1::Group, Fingers::Rooms::Floor1::RoomE, true);
	...
	if (entityA->getTag() == Fingers::Entities::StarDiamond) {
		...
		if (entityB->getTag() == Fingers::Entities::DoorWest) {
			moveToRoom(entityA, Fingers::Rooms::Floor1::Group, Fingers::Rooms::Floor1::RoomG, Fingers::Rooms::Floor1::Group, Fingers::Rooms::Floor1::StartingRoom);

			entityA->translate(Vector2(0.5F, 0.0F));
		}
	
		if (entityB->getTag() == Fingers::Entities::DoorNorth) {
			moveToRoom(entityA, Fingers::Rooms::Floor1::Group, Fingers::Rooms::Floor1::RoomG, Fingers::Rooms::Floor1::Group, Fingers::Rooms::Floor1::RoomE);
