-- Kala - Moon of Time, death, and destruction
-----------------------------------------------
...
function setupMoon01()
	...
	enemyBases[0][1]:append({ 	basePosition = { y = 9*16, x = 17*16 },
					...
					width = 32, height = 32,
					baseEnemy = { path = "SinLeft", u = 16, v = 16, speed = 2.0, health = 1.0, score = 10, time = os.clock() }
	});
	...
	enemyBases[4][0]:append({ 	basePosition = { y = 9*16, x = 17*16 },
					baseHealth = 50,
					baseCounter = 25,
					baseRespawn = 15,
					aliveU = 0, deadU = 32,
					...
					offsetX = 0, offsetY = -16,
					width = 32, height = 32,
 					baseEnemy = { path = "SinLeft", u = 80, v = 16, speed = 0.25, health = 1.0, score = 10, time = os.clock() }
	});

	enemyBases[3][2]:append({ 	basePosition = { y = 8*16, x = 5*16 },
					baseHealth = 25,
					baseCounter = 25,
					baseRespawn = 15,
					aliveU = 32, deadU = 240,
					...
					offsetX = 0, offsetY = 0,
					width = 16, height = 16,
 					baseEnemy = { path = "DropUpRight", u = 32 , v = 32, speed = 0.5, health = 1.0, score = 10, time = os.clock() }
	});

	enemyBases[3][2]:append({ 	basePosition = { y = 8*16, x = 14*16 },
					baseHealth = 25,
					baseCounter = 25,
					baseRespawn = 15,
					aliveU = 48, deadU = 240,
					...
					offsetX = 0, offsetY = 0,
					width = 16, height = 16,
 					baseEnemy = { path = "DropUpLeft", u = 32 , v = 32, speed = 0.5, health = 1.0, score = 10, time = os.clock() }
	});

	enemyBases[4][2]:append({ 	basePosition = { y = 10*16, x = 5*16 },
					baseHealth = 25,
					baseCounter = 25,
					baseRespawn = 15,
					aliveU = 32, deadU = 240,
	...
	enemyBases[4][2]:append({ 	basePosition = { y = 10*16, x = 14*16 },
					baseHealth = 25,
					baseCounter = 25,
					baseRespawn = 15,
					aliveU = 48, deadU = 240,
	...
	enemyBases[4][1]:append({ 	basePosition = { y = 10*16, x = 5*16 },
					baseHealth = 25,
					baseCounter = 25,
					baseRespawn = 15,
					aliveU = 32, deadU = 240,
					...
					offsetX = 0, offsetY = 0,
					width = 16, height = 16,
 					baseEnemy = { path = "DropUpRight", u = 32 , v = 32, speed = 1.0, health = 1.0, score = 10, time = os.clock() }
	});

	enemyBases[4][1]:append({ 	basePosition = { y = 10*16, x = 14*16 },
					baseHealth = 25,
					baseCounter = 25,
					baseRespawn = 15,
					aliveU = 48, deadU = 240,
					...
					offsetX = 0, offsetY = 0,
					width = 16, height = 16,
 					baseEnemy = { path = "DropUpLeft", u = 32 , v = 32, speed = 1.0, health = 1.0, score = 10, time = os.clock() }
	});

	enemyBases[0][2]:append({ 	basePosition = { y = 8*16, x = 8*16 },
					baseHealth = 25,
					baseCounter = 25,
					baseRespawn = 15,
					aliveU = 32, deadU = 240,
					...
					offsetX = 0, offsetY = 0,
					width = 16, height = 16,
 					baseEnemy = { path = "SinRight", u = 32 , v = 32, speed = 1.5, health = 1.0, score = 10, time = os.clock() }
	});

	enemyBases[0][2]:append({ 	basePosition = { y = 8*16, x = 14*16 },
					baseHealth = 25,
					baseCounter = 25,
					baseRespawn = 15,
					aliveU = 48, deadU = 240,
					...
					offsetX = 0, offsetY = 0,
					width = 16, height = 16,
 					baseEnemy = { path = "SinLeft", u = 32 , v = 32, speed = 1.5, health = 1.0, score = 10, time = os.clock() }
	});

	enemyBases[4][4]:append({ 	basePosition = { y = 8*16, x = 14*16 },
					baseHealth = 25,
					baseCounter = 25,
					baseRespawn = 15,
					aliveU = 48, deadU = 240,
	...
	enemyBases[0][3]:append({ 	basePosition = { y = 3*16, x = 8*16 },
					baseHealth = 25,
					baseCounter = 25,
					baseRespawn = 15,
					aliveU = 64, deadU = 240,
					...
					offsetX = 0, offsetY = 0,
					width = 16, height = 16,
 					baseEnemy = { path = "DropDownRight", u = 32 , v = 32, speed = 0.5, health = 1.0, score = 10, time = os.clock() }
	});

	enemyBases[0][3]:append({ 	basePosition = { y = 3*16, x = 14*16 },
					baseHealth = 25,
					baseCounter = 25,
					baseRespawn = 15,
					aliveU = 80, deadU = 240,
					...
					offsetX = 0, offsetY = 0,
					width = 16, height = 16,
 					baseEnemy = { path = "DropDownLeft", u = 32 , v = 32, speed = 0.5, health = 1.0, score = 10, time = os.clock() }
	});
	...
	researchBases[4][4] = {	room = { y = 4, x = 4 },
	...
	researchBases[0][4] = {	room = { y = 0, x = 4 },
...
function setupMoon02()
	...
	enemyBases[0][4]:append({ 	basePosition = { y = 3*16, x = 11*16 },
					baseHealth = 50,
					baseCounter = 25,
					baseRespawn = 15,
					aliveU = 0, deadU = 32,
	...
	enemyBases[0][2]:append({ 	basePosition = { y = 7*16, x = 14*16 },
					baseHealth = 50,
					baseCounter = 25,
					baseRespawn = 15,
					aliveU = 0, deadU = 32,
					...
					width = 32, height = 32,
 					baseEnemy = { path = "Left", u = 16, v = 16, speed = 0.5, health = 1.0, score = 10, time = os.clock() }
	});

	enemyBases[0][2]:append({ 	basePosition = { y = 3*16, x = 2*16 },
					baseHealth = 50,
					baseCounter = 25,
					baseRespawn = 15,
					aliveU = 0, deadU = 32,
	...
	enemyBases[1][3]:append({ 	basePosition = { y = 8*16, x = 8*16 },
					baseHealth = 25,
					baseCounter = 25,
					baseRespawn = 15,
					aliveU = 32, deadU = 240,
	...
	enemyBases[1][3]:append({ 	basePosition = { y = 8*16, x = 14*16 },
					baseHealth = 25,
					baseCounter = 25,
					baseRespawn = 15,
					aliveU = 48, deadU = 240,
	...
	enemyBases[1][3]:append({ 	basePosition = { y = 3*16, x = 8*16 },
					baseHealth = 25,
					baseCounter = 25,
					baseRespawn = 15,
					aliveU = 64, deadU = 240,
	...
	enemyBases[1][3]:append({ 	basePosition = { y = 3*16, x = 14*16 },
					baseHealth = 25,
					baseCounter = 25,
					baseRespawn = 15,
					aliveU = 80, deadU = 240,
	...
	enemyBases[2][2]:append({ 	basePosition = { y = 8*16, x = 8*16 },
					baseHealth = 25,
					baseCounter = 25,
					baseRespawn = 15,
					aliveU = 32, deadU = 240,
	...
	enemyBases[2][2]:append({ 	basePosition = { y = 8*16, x = 14*16 },
					baseHealth = 25,
					baseCounter = 25,
					baseRespawn = 15,
					aliveU = 48, deadU = 240,
	...
	enemyBases[2][2]:append({ 	basePosition = { y = 3*16, x = 8*16 },
					baseHealth = 25,
					baseCounter = 25,
					baseRespawn = 15,
					aliveU = 64, deadU = 240,
	...
	enemyBases[2][2]:append({ 	basePosition = { y = 3*16, x = 14*16 },
					baseHealth = 25,
					baseCounter = 25,
					baseRespawn = 15,
					aliveU = 80, deadU = 240,
	...
	enemyBases[3][2]:append({ 	basePosition = { y = 3*16, x = 3*16 },
					baseHealth = 25,
					baseCounter = 25,
					baseRespawn = 15,
					aliveU = 64, deadU = 240,
					...
					offsetX = 0, offsetY = 0,
					width = 16, height = 16,
 					baseEnemy = { path = "DropDownRight", u = 32 , v = 32, speed = 2.0, health = 1.0, score = 10, time = os.clock() }
	});

	enemyBases[3][2]:append({ 	basePosition = { y = 8*16, x = 3*16 },
					baseHealth = 25,
					baseCounter = 25,
					baseRespawn = 15,
					aliveU = 32, deadU = 240,
					...
					offsetX = 0, offsetY = 0,
					width = 16, height = 16,
 					baseEnemy = { path = "SinRight", u = 32 , v = 32, speed = 2.0, health = 1.0, score = 10, time = os.clock() }
	});

	enemyBases[4][4]:append({ 	basePosition = { y = 1*16, x = 16*16 },
					baseHealth = 25,
					baseCounter = 25,
					baseRespawn = 10,
					aliveU = 80, deadU = 240,
					...
					offsetX = 0, offsetY = 0,
					width = 16, height = 16,
 					baseEnemy = { path = "DropDownLeft", u = 32 , v = 32, speed = 2.0, health = 1.0, score = 10, time = os.clock() }
	});
